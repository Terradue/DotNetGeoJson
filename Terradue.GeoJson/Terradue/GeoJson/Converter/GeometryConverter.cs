...
namespace Terradue.GeoJson.Converter
{
  public class GeometryConverter : JsonConverter
  {
    ...
    {
      return (objectType == typeof(MultiPolygon)) || (objectType == typeof(Polygon)) ||
             (objectType == typeof(MultiLineString)) || (objectType == typeof(LineString)) ||
             (objectType == typeof(MultiPoint)) || (objectType == typeof(Point));
    }
