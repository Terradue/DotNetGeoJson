...
namespace Terradue.GeoJson.Feature {
    ...
    public class PointFeature : Feature {
        ...
        public PointFeature(Point geometry, Dictionary<string, object> properties = null) : base(geometry, properties) {
            Geometry = geometry;
        }
        ...
        /*public new static PointFeature ParseJson(string json) {

            Point geometry = new Point();
            var mpObj = JsonObject.Parse(json);

            geometry = mpObj.JsonTo<Point>("geometry");

            PointFeature mp = new PointFeature(geometry, mpObj.JsonTo<Dictionary<string, object>>("properties"));
