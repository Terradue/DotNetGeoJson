...
* 
* This file is part of Terradue.GeoJson.
* 
...
@{
    ...
    \xrefitem sw_version "Versions" "Software Package Version" 1.9.1
...
[assembly: AssemblyDescription("Initially developed to provide an easy way to manage Geometry objects with serialization and deserialization functions and transformation functions from/to GeoJson, it also supports GML, georss and Well Known Text (WKT)")]
