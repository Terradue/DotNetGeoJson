...
namespace Terradue.GeoJson.Tests
{
  ...
  public class DeserializationTest
  {
    ...
    {
      var fs = new FileStream("MultiPolygon.geojson".TestDirectory(), FileMode.Open);
      ...
      JToken jsonin;
      fs = new FileStream("MultiPolygon.geojson".TestDirectory(), FileMode.Open);
    ...
    {
      var fs = new FileStream("Samples/s1.json".TestDirectory(), FileMode.Open);
    ...
    {
      var fs = new FileStream("Samples/ASA_IM__0.json".TestDirectory(), FileMode.Open);
    ...
    {
      var geometry =
        WktExtensions.WktToGeometry(
          "MULTIPOLYGON(((-129.968719 48.14193,-129.968719 48.14193,-131.056732 48.272541,-131.056732 48.272541,-130.657394 49.769352,-130.657394 49.769352,-129.536499 49.638176,-129.536499 49.638176,-129.968719 48.14193)))");

      Assert.AreEqual(
        "MULTIPOLYGON(((-129.968719 48.14193,-131.056732 48.272541,-130.657394 49.769352,-129.536499 49.638176,-129.968719 48.14193)))",
        geometry.ToWkt());
